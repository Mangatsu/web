...
echo "Checking NEXT_PUBLIC_MANGATSU_API_UR and NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL environmentals"
test -n "$NEXT_PUBLIC_MANGATSU_API_URL"
test -n "$NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL"

echo "Setting NEXT_PUBLIC_MANGATSU_API_UR and NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL environmentals"
...
find /mtsu-web/.next \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i "s#APP_NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL#$NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL#g"
