...
RUN env NEXT_PUBLIC_MANGATSU_API_URL=APP_NEXT_PUBLIC_MANGATSU_API_URL NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL=APP_NEXT_PUBLIC_INTERNAL_MANGATSU_API_URL npm run build
